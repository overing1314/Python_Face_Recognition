...
folder_name = []
for entry_name in os.listdir('data/data_faces_from_camera/'):
	entry_path = os.path.join('data/data_faces_from_camera/',entry_name)
	if os.path.isdir(entry_path):
		folder_name.append(entry_name)
...
class Face_Recognizer:
    ...
    def show_chinese_name(self):
        ...
        if self.current_frame_face_cnt >= 1:
            self.face_name_known_list[0] = folder_name[0].encode('utf-8').decode()
